...
async function main() {
  ...
  const citySeeds = [
    ...
    { slug: 'coachella', name: 'Coachella', county: 'Riverside County' as const, office: 'Palm Springs Office', courthouse: 'Riverside County Superior Court — Palm Springs Courthouse, 3255 E. Tahquitz Canyon Way, Palm Springs (verified: handles civil and personal injury cases locally)', highways: ['I-10', 'SR-86'] },
  ...
  const nearbyMap: Record<string, string[]> = {
    ...
    indio: ['la-quinta', 'palm-desert', 'cathedral-city', 'coachella'],
    'cathedral-city': ['palm-springs', 'rancho-mirage'],
    'la-quinta': ['indio', 'palm-desert', 'coachella'],
    coachella: ['indio', 'la-quinta', 'cathedral-city'],
