...
const SPANISH_STATIC_PI_CITY_SLUGS = new Set(['indio', 'colton', 'rancho-cucamonga', 'hemet', 'cathedral-city', 'desert-hot-springs', 'yucaipa', 'la-quinta', 'ontario', 'coachella', 'rancho-mirage'])
