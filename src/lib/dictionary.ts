...
export const dictionary = {
  en: {
    ...
    home: {
      ...
      trust: ['15+ years practicing', '2,500+ families helped', 'No fee unless we win'],
      servicesKicker: 'How we help',
      piName: 'Personal Injury',
      piDesc: 'Car, truck, motorcycle, rideshare, dog bite, and wrongful death claims on contingency — you owe nothing unless we win.',
      bkName: 'Bankruptcy',
    ...
    contact: {
      ...
      form: {
        ...
        subheading: "Prefer to write instead of call? We'll get back to you.",
        fullName: 'Full name',
        email: 'Email',
        phone: 'Phone',
        practiceArea: "What's this about?",
        practiceAreaOptions: {
          '': 'Select one',
        ...
        referralOptions: {
          ...
          referral_personal: 'A friend or family member',
          referral_attorney: 'Another attorney',
          maps: 'Google Maps',
          social: 'Social media',
          website: 'I found the website directly',
          other: 'Other',
        },
        referralDetail: 'Feel free to add more detail (optional)',
        smsConsent: 'I agree to receive text messages about my inquiry',
        submit: 'Send Message',
        submitting: 'Sending\u2026',
      },
    },
  ...
  es: {
    ...
    home: {
      ...
      trust: ['Más de 15 años de experiencia', 'Más de 2,500 familias ayudadas', 'No paga a menos que ganemos'],
      servicesKicker: 'Cómo ayudamos',
      piName: 'Lesiones Personales',
      piDesc: 'Accidentes de auto, camión, motocicleta, rideshare, mordeduras de perro y muerte por negligencia a contingencia.',
      bkName: 'Bancarrota',
    ...
    contact: {
      ...
      form: {
        ...
        subheading: '¿Prefiere escribir en lugar de llamar? Le responderemos.',
        fullName: 'Nombre completo',
        email: 'Correo electrónico',
        phone: 'Teléfono',
        practiceArea: '¿De qué se trata?',
        practiceAreaOptions: {
          '': 'Seleccione una opción',
          'personal-injury': 'Lesiones Personales',
          bankruptcy: 'Bancarrota',
          other: 'No estoy seguro / Otro',
        },
        message: 'Cuéntenos qué pasó',
        referralSource: '¿Cómo se enteró de nosotros?',
        referralOptions: {
          '': 'Seleccione una opción',
          search: 'Google / búsqueda en línea',
          referral_personal: 'Un amigo o familiar',
          referral_attorney: 'Otro abogado',
          maps: 'Google Maps',
          social: 'Redes sociales',
          website: 'Encontré el sitio web directamente',
          other: 'Otro',
        },
        referralDetail: 'Puede agregar más detalles (opcional)',
        smsConsent: 'Acepto recibir mensajes de texto sobre mi consulta',
