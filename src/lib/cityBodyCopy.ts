  ...
  'palm-springs': {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Who may bring the suit is confirmed in the consult under California Code of Civil Procedure §377.60 — we do not invent verdicts or settlement stories. Unlimited civil files for Palm Springs are filed at Riverside County Superior Court — Palm Springs Courthouse, 3255 E. Tahquitz Canyon Way — not Oasis Street, not 4050 Main Street, not 247 W. 3rd Street, and not any Indio Division leftover routing. The courthouse sits about 3.2 miles and 7 minutes west-northwest from City Hall at 3200 East Tahquitz Canyon Way when you route Civic \u2192 Tahquitz \u2192 Sunrise \u2192 Tachevah \u2192 N Palm Canyon.',
        ],
      },
      {
        h2: 'Catastrophic injury — TBI, spinal cord, lost limb',
