...
function isPiPathWithDemotedPostCtaHeadings(pathname: string) {
  ...
  return (
    ...
    normalized === '/personal-injury/indio' ||
    normalized === '/es/lesiones-personales/indio' ||
    normalized === '/personal-injury/colton' ||
    normalized === '/es/lesiones-personales/colton' ||
    ...
    normalized === '/personal-injury/desert-hot-springs' ||
    normalized === '/es/lesiones-personales/desert-hot-springs' ||
    normalized === '/personal-injury/yucaipa' ||
    normalized === '/es/lesiones-personales/yucaipa' ||
    normalized === '/personal-injury/la-quinta' ||
    normalized === '/es/lesiones-personales/la-quinta' ||
    normalized === '/personal-injury/ontario' ||
    normalized === '/es/lesiones-personales/ontario' ||
    normalized === '/personal-injury/coachella' ||
    normalized === '/es/lesiones-personales/coachella' ||
    normalized === '/personal-injury/rancho-mirage' ||
    normalized === '/es/lesiones-personales/rancho-mirage'
  )
}
